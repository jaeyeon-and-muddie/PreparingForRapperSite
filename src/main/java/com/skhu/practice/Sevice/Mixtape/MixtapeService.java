...
import com.skhu.practice.DTO.AlbumDto.SoundCloudDto;
import com.skhu.practice.DTO.MixtapeDto.MixtapeCreateDto;
import com.skhu.practice.DTO.MixtapeDto.MixtapeDetailDto;
import com.skhu.practice.DTO.MixtapeDto.MixtapeDto;
import com.skhu.practice.DTO.MixtapeDto.MixtapeIntroDto;
import com.skhu.practice.Entity.mixtape.Mixtape;
import com.skhu.practice.Entity.mixtape.MixtapeIntro;
import com.skhu.practice.Repository.Mixtape.MixtapeIntroRepository;
...
public class MixtapeService {
    ...
    public void recommend(Long id, UserSessionDto user)
    {
        ...
        if (mixtape.getRecommend().size()<1) {
